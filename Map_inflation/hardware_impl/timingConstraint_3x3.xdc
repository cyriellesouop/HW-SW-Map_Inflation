...
resize_pblock [get_pblocks pblock_top] \
    -add {SLICE_X36Y1:SLICE_X65Y38 \
          DSP48_X1Y2:DSP48_X1Y13 \
          RAMB18_X1Y2:RAMB18_X2Y13 \
          RAMB36_X1Y1:RAMB36_X2Y6} -locs keep_all
...
set_property DONT_TOUCH TRUE \
    [get_nets -hier -filter {NAME =~ "*rstn*"}]

# Input partition pins — INT_L_X24 is the confirmed left edge
set_property HD.PARTPIN_LOCS INT_L_X24Y1 [get_ports rstn]
