...
/* ---------------------------------------------------------
   5x5 inflation kernel 

static const uint16_t kernel5x5[KSIZE][KSIZE] = {
    { 20,  40,  60,  40,  20},
    { 40,  80, 120,  80,  40},
    { 60, 120, 254, 120,  60},
    { 40,  80, 120,  80,  40},
...
/*static const uint16_t kernel7x7[KSIZE][KSIZE] = {
                                ...
                                double   *mul_time_ms)
{
    ...
    *mul_time_ms = 0.0;
    ...
    for (int k = 0; k < n; k++)
        mat_mul_3x3(patches[k].patch, kernel9x9, all_results[k]);
